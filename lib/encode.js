...
/**
 * @typedef {import('./interfaces').EncodeOptions} EncodeOptions
 * @typedef {import('./interfaces').OptionalTypeEncoder} OptionalTypeEncoder
 * @typedef {import('./interfaces').Reference} Reference
 * @typedef {import('./interfaces').StrictTypeEncoder} StrictTypeEncoder
 * @typedef {import('./interfaces').TokenTypeEncoder} TokenTypeEncoder
 * @typedef {import('./interfaces').TokenOrNestedTokens} TokenOrNestedTokens
 */
