...
/**
 * @typedef {import('../interfaces').DecodeTokenizer} DecodeTokenizer
 */
...
class Tokenizer {
  ...
  parseNumber () {
    ...
    if (this.ch() === 48) { // '0'
      ...
      if (this.ch() === 46) { // '.'
        ...
        throw new Error(`Invalid leading 0 for number at position ${this.pos}`)
      }
    }
  ...
  parseString () {
    ...
    throw new Error('Unexpected string parse error')
  }
  ...
  next () {
    ...
    switch (this.currentMode()) {
      ...
      default:
        throw new Error('Unexpected parse erorr')
    }
  }
}
