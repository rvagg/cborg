 ...
 * @returns {Uint8Array}
 */
export function encodeCustom(data: any, encoders: TokenTypeEncoder[], options: EncodeOptions, destination?: Uint8Array | undefined): Uint8Array;
/**
 * @param {any} data
 * @param {Uint8Array} destination
 * @param {EncodeOptions} [options]
 * @returns {Uint8Array}
 */
export function encodeInto(data: any, destination: Uint8Array, options?: import("../interface").EncodeOptions | undefined): Uint8Array;
